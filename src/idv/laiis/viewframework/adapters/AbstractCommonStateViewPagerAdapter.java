 ...
 * @param <T>
 */
public abstract class AbstractCommonStateViewPagerAdapter<T> extends FragmentStatePagerAdapter{
	...
	public AbstractCommonStateViewPagerAdapter(Context context,FragmentManager fm) {
		super(fm);
